...
public class Snake extends JPanel implements ActionListener, KeyListener {
    ...
    //     JOptionPane.showMessageDialog(this, "You've eaten 5 foods! Get ready for a question.",
    ...
    //   int questionCount = 1;
        ...
        String answer = JOptionPane.showInputDialog(this, "What is the alphabet's " + questionCount + " letter?", "Question",
                JOptionPane.QUESTION_MESSAGE);
                questionCount++;

        if (answer != null && answer.equalsIgnoreCase(String.valueOf(currentAlphabet))) {
            currentAlphabet++;
            foodEaten = 0;
    ...
    public static void main(String[] args) {
        ...
        Snake snakeGame = new Snake(800, 600);
        frame.add(snakeGame);
        frame.pack();
